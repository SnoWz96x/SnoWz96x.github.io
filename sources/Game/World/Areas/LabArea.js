    ...
    setImages()
    {
        ...
        this.images.getResourceAndLoad = (key) =>
        {
            ...
            if(!resource)
            {
                ...
                const textureType = /\.(png|jpe?g|webp)$/i.test(key) ? 'texture' : 'textureKtx'
                const loader = this.game.resourcesLoader.getLoader(textureType)
            ...
            for(const project of labData)
            {
                ...
                // Image
                {
                    ...
                    mini.startLoading = () =>
                    {
                        ...
                        const textureType = /\.(png|jpe?g|webp)$/i.test(project.imageMini) ? 'texture' : 'textureKtx'
                        const loader = this.game.resourcesLoader.getLoader(textureType)
